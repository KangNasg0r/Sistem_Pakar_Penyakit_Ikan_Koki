...
--
-- Host: localhost:3306
-- Generation Time: Jun 19, 2026 at 02:28 PM
...
CREATE TABLE `hasil_kemungkinan_diagnosa` (
  ...
  `id_diagnosa` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `kode_penyakit` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
